...
text("the travel time would be absurd.",505,-640)
 pop()
...
text("you are viewing from. On a disk, all eyes  ",-950,-320)
text("located on the top side would have the ",-945, -280) 
text("same view.  ",-945, -240) 
text ( "(Not Including Light Pollution)",-945,-200)
pop()
...
pop()
 ...
 textSize(height / 45)
 textAlign(TOP, LEFT)
 text('If we live on a flat plane, we would only   ', -945,-120)
text(" need 2 or 3 sattelites for a positioning  ",-950,-80)
text("system that covers the entire Earth. ",-945, -40)
text("With a spherical planet, signals get cut  ",-945,-0)
text('off at certain distances. We need at least  ', -945,35)
text(" 24 to transmit flat-earth propoganda  ",-950,70)
text("world-wide. ",-945, 105) 
pop()
...
push()
 ...
 textSize(height / 45)
 textAlign(TOP, LEFT)
 text('This map is one of the most popular   ', 505,-120)
text("used by flat-earthers. Ironically, it is  ",505,-80)
text("actually a flattened 2D representation   ",505, -40)
text("of a globe when viewed from the top.  ",505,00)
text('Very Distorted, Very innacurate, Kind of Cool  ', 505,35)
//text(" spherical objects which are tidally  ",500,70)
//text("locked in position. This is why we see  ",505, 105) 
//text("same face of the moon all over the  ",505, 140) 
//text("Earth, all year round.",505, 175) 
pop()
